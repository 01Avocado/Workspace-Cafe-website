...
export default function FeatureSection() {
    return (
        <section id="locations" className="py-24 px-4 md:px-8 relative overflow-hidden">
            {/* Background Gradient */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        {features.filter((f: FeatureHighlight) => f.position === 'left').map((feature: FeatureHighlight, i: number) => (
                            <motion.div
                                key={i}
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1.8, scale: 1.8 }}
                        viewport={{ once: true }}
                    ...
                    >
                        <div className="relative">
                            ...
                            <img
                                src="/coffee/cup-centered-transparent.png"
                    ...
                    {/* Right Features */}
                    <div className="space-y-8">
                        {features.filter((f: FeatureHighlight) => f.position === 'right').map((feature: FeatureHighlight, i: number) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, x: 50 }}
                                whileInView={{ opacity: 1, x: 0 }}
